...
*Próximas etapas (ordem do backlog): US-12 (teste de leitura do mapa com Pedro) → US-15 (notebook-roteiro de exploração pra Pedro) → US-18/19 (instruções de reprodução no README e documentação de atualização de dados) → US-17 (ensaio da demo com os dois, 2 dias antes de 07/08). Painel e narrativa prontos; faltam os 4 passos finais até a apresentação.*
