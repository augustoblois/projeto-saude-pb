...
**DE PASSAGEM:** `plotly` faltava no `requirements.txt` desde a Etapa 15 — o painel importava uma biblioteca que a lista de instalação não mencionava, e quebraria numa máquina limpa. Adicionado; travar as versões segue sendo a US-18.
